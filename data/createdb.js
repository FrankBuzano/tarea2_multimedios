...
const insert = db.prepare(/* SQL */ `
  INSERT INTO mundiales (
    nombre, anio, sede, campeon, subcampeon,
    goleador, equipos, imagen, slug, resumen, descripcion
  ) VALUES (
    :nombre, :anio, :sede, :campeon, :subcampeon,
    :goleador, :equipos, :imagen, :slug, :resumen, :descripcion
  )
...
console.log(`Base de datos creada y poblada con ${data.length} mundiales.`);
